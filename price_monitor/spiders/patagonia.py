...
PRICE_STD_SELECTOR = "#hero-pdp__buy > div > div.buy-config__title.sk-init.sk-viewport-in.sk-show-first.sk-show-complete > div > span.js-buy-config-price.buy-config-price > div > span > span > span"  # noqa
PRICE_SALE_SELECTOR = "#hero-pdp__buy > div > div.buy-config-attributes > div > div:nth-child(1) > div > div > div > a:nth-child(1) > div > div.product-tile__meta > div > div > div > div > span > span > span"  # noqa
...
PRICE_SELECTOR_28102023 = "body > main > section > div.page.page-pdp.product-detail.page-pdp-2-col > section > div.page-pdp-2-col__right-column > div > div.pdp-intro > span > div > span > span > span"  # noqa
...
class PatagoniaSpider(CrawlSpider):
    ...
    def get_price(self, response):
        ...
        prices = [price for price in [price_sale, price_min, price_max, price_std, price_not_sale, price_28102023] if price > 0]  # noqa
